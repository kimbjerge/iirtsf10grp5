...
all : $(TARGET_NAME)$(EXE_EXT) Target.mak

TARGET_MAIN=MainTarget
...
PowerOnSelfTest.o : PowerOnSelfTest.cpp PowerOnSelfTest.h    Discrete.h Failure.h Initializing.h ESXState.h EmbeddedSystemX.h 
...
Test1.o : Test1.cpp Test1.h    Discrete.h CommandCreator.h SelfTestOk.h Creator.h Initialized.h Restart.h ConfigurationEnded.h Start.h Resume.h Configure.h Stop.h ChMode.h SelfTestFailed.h Exit.h Suspend.h RunRealTime.h Simulate.h EmbeddedSystemX.h TestCase.h Command.h 
...
Test2.o : Test2.cpp Test2.h    Discrete.h CommandCreator.h SelfTestOk.h Restart.h Creator.h Initialized.h Suspend.h ConfigurationEnded.h Start.h Resume.h Configure.h Stop.h ChMode.h SelfTestFailed.h Exit.h RunRealTime.h Simulate.h EmbeddedSystemX.h TestCase.h Command.h 
...
SimulateAndState.o : SimulateAndState.cpp SimulateAndState.h    Discrete.h RealTimeLoop.h EmbeddedSystemX.h 
...
Simulation.o : Simulation.cpp Simulation.h    Discrete.h SimulatorTask.h RealTimeExecution.h RealTimeLoop.h EmbeddedSystemX.h SimulateAndState.h 
...
RealTimeExecution.o : RealTimeExecution.cpp RealTimeExecution.h    Discrete.h Simulation.h SimulateAndState.h RealTimeLoop.h EmbeddedSystemX.h 
...
SimulatorTask.o : SimulatorTask.cpp SimulatorTask.h    Continuous.h RealTimeThread.h Event.h EventX.h EventY.h 
	@echo Compiling SimulatorTask.cpp
	$(CREATE_OBJ_DIR)
	@$(CC) $(ConfigurationCPPCompileSwitches)  -o SimulatorTask.o SimulatorTask.cpp
...
Continuous.o : Continuous.cpp Continuous.h    RealTimeThread.h EventStrategy.h M1Strategy.h M2Strategy.h M3Strategy.h Event.h EventX.h EventY.h SimulatorTask.h 
...
####################################################################################
$(TARGET_NAME)$(EXE_EXT): $(OBJS) $(ADDITIONAL_OBJS) $(TARGET_MAIN)$(OBJ_EXT) Target.mak 
...
$(TARGET_NAME)$(LIB_EXT) : $(OBJS) $(ADDITIONAL_OBJS) Target.mak
